...
const LabelItems = ({
  ...
  let labelItems: any = <p>当前数据库中没有节点标签</p>
  if (labels.length) {
...
const RelationshipItems = ({
  ...
  let relationshipItems: any = <p>当前数据库中没有关系类型</p>
  ...
  return (
    <DrawerSection>
      <DrawerSubHeader>关系类型</DrawerSubHeader>
      <DrawerSectionBody className={wrapperStyle}>
        {relationshipItems}
      </DrawerSectionBody>
      <ShowMore
...
const PropertyItems = ({
  ...
  let propertyItems: any = <p>当前数据库中没有属性信息</p>
  ...
  return (
    <DrawerSection>
      <DrawerSubHeader>属性健值</DrawerSubHeader>
      <DrawerSectionBody className={wrapperStyle}>
        {propertyItems}
      </DrawerSectionBody>
      <ShowMore
